    ...
    case appointmentConstants.APPOINTMENT_DELETE:
      ...
      return {
        ...
        items: state.items.map(function (appointment) {
           console.log(appointment.StartTime + appointment.DogName + "::" + action.StartTime + action.DogName);
           console.log(action);
           return (appointment.StartTime + appointment.DogName) === (action.StartTime + action.DogName)
